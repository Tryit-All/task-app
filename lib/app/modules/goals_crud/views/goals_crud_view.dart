...
class GoalsCrudView extends GetView<GoalsCrudController> {
  GoalsCrudView({Key? key}) : super(key: key);

  final controller = Get.put(GoalsCrudController());
  ...
  void _showQuantityDialog(
    ...
    double textScaleFactor = MediaQuery.of(context).textScaleFactor;
    final controller = Get.find<GoalsCrudController>();
