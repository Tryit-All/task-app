...
class ProyekBaruView extends GetView<ProyekBaruController> {
  final controller = Get.put(ProyekBaruController());
          ...
          actions: [
            Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    // Get.to(AllTeamView());
                    Get.to(DetailTugasView(), arguments: {
                      'title': 'Proyek Baru',
                    });
                  },
                  child: Text(
  ...
  void _showQuantityDialog(
    ...
    double textScaleFactor = MediaQuery.of(context).textScaleFactor;
    final controller = Get.find<ProyekBaruController>();
